...
function add_points_to_map(points_array) {
  var real_y_coord=parseFloat(points_array[points_array.length -1][2],10)+20;
/*BUGGGGGGGGGGGGGG
  ...
  for (var point=0; point<points_array.length; point++){
    ...
    if (point+1<points_array.length) {
      if (points_array[point][0] == points_array[point+1][0]) {
        ...
        var comment_line=points_array[point][11]+' km entre '+points_array[point+1][0]+' et '+points_array[point][0] + ' à ' + points_array[point][4];
      }
